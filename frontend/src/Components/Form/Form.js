        ...
        <FormStyled onSubmit={handleSubmit}>
            ...
            <div className="selects input-control">
                <select required value={category} name="category" id="category" onChange={handleInput('category')}>
                    ...
                    <option value="stocks">Poupança</option>
                    <option value="bitcoin">Bitcoin/Moeda virtual</option>
            ...
            <div className="input-control">
                <textarea name="description" value={description} placeholder='Adicione uma observação' id="description" cols="30" rows="4" onChange={handleInput('description')}></textarea>
            </div>
